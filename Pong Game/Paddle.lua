...
--[[
    The updateAI function takes a ball as parameter and changes the y coordinate 
    of the paddle in a way that the center of the paddle is always aligned with the
    cnter of the ball. 
]]
